...
real(8),dimension(nz,ny) :: fz,fy,Fz_2,FY_2
   ...
   do itr=1,iadvance_time
     ...
     !X-->Y-->Z-->Y-->X
      call convdiff(ux1,uy1,uz1,ta1,tb1,tc1,td1,te1,tf1,tg1,th1,ti1,di1,&
           ...
           ux3,uy3,uz3,ta3,tb3,tc3,td3,te3,tf3,tg3,th3,ti3,di3,FZ_P,FY_P,FY_N,FZ_N)  !! omar      
      if (iscalar==1) then
...
!      if (nrank==1) ux1(12,64,:)=-1.
   ...
   call saveBox (ux1,uy1,uz1,1,128,1,129,1,84)
  ...
  open (1,file='comu_stat.dat')
      write(1,*) 1./xnu,itime,ifirst,nx, ny, nz
  close(1)
	 print*, ''
...
IF (NRANK .EQ.0) then 
  open (1,file='comu_stat.dat')
      write(1,*) 1./xnu,ilast,ifirst,nx, ny, nz
  close(1)
	call system('./stats.out')
endif
