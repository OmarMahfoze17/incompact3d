...
real(mytype), save, allocatable, dimension(:,:,:) :: FY_P,FY_N,FZ_P,FZ_N ! omar
...
real(mytype), save, allocatable, dimension(:,:,:) :: phimean, phiphimean,vort_mean,vort_2_mean ! omar
...
!************* omar *******************
call alloc_x(FY_P, opt_global=.true.)  !!!-******* OMAR
call alloc_x(FY_N, opt_global=.true.)  !!!-******* OMAR
call alloc_x(FZ_P, opt_global=.true.)  !!!-******* OMAR
call alloc_x(FZ_N, opt_global=.true.)  !!!-******* OMAR
!************* omar *******************    
